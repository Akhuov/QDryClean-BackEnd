...
{
    public class SoftDeleteItemCategoryCommandValidator
        : AbstractValidator<SoftDeleteItemCategoryCommand>
    {
        private readonly IApplicationDbContext _dbContext;
        public SoftDeleteItemCategoryCommandValidator(IApplicationDbContext dbContext)
        {
